...
<body>
	<div ng-app="app" ng-controller="ctrl" class="container col-md-8 col-md-offset-2">
				...
				<div class="panel-body">
						...
						<dl>
							<dd>
								...
								<div class="input-group">
									<input type="text" class="form-control" placeholder="请输入名称" data-rule="required" ng-model="params.user_name">
								</div>
							</dd>
							<dd>
								<label class="control-label">性别：</label>
								<div class="input-group">
									<select ng-model="params.user_sex" class="form-control" data-rule="required">
							...
							<dd>
								<input type="button" class="btn btn-info" ng-click="query(true)" value="查询" /> <a href="javascript:;"
									class="btn btn-success" ng-click="gotoitem()">新增用户</a>
							</dd>
						</dl>
					</div>
					<div class="table-responsive">
						<table style="table-layout: fixed;" class="table table-bordered table-hover tabstyle">
							...
							<tbody>
								<tr ng-repeat="row in rows" ng-cloak>
		...
		<div ng-if="!mainshow" ui-view></div>
	</div>
</body>
</html>